...
<form id = "new"  method = "post">
        ...
        <tr> 
         ...
         <tr>
             <td> Surname: </td>
             <td> <input type = "text" name = "lname" placeholder = "Surname.."></td>
         </tr>
         <tr>
             <td> Department: </td>
...
if(mysqli_select_db($conn,$dbname )){
    ...
    $sql="INSERT IGNORE INTO  student(ID, fname, lname, dept_name) values ('$ID', '$fname', '$lname', '$dept_name')"  or die (mysqli_error());
